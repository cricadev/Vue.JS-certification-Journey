...
const CSSMeasurementConverter_js_1 = __importDefault(require("../css/declaration/measurement-converter/CSSMeasurementConverter.cjs"));
...
class MediaQueryItem {
    ...
    matchesMediaType(mediaType) {
        if (mediaType === MediaQueryTypeEnum_js_1.default.all) {
            return true;
        }
